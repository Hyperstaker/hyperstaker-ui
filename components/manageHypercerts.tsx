...
export default function ManageHypercert({
  ...
  return (
    <div className="basis-10/12 mx-auto">
      ...
      <article className=" group rounded-2xl border p-2 hover:border-primary-500" style={{ borderColor: designTokens.semantic.border.primary }}>
        ...
        <div className="px-4">
          <div className="flex">
            <div className="p-2 mr-16 flex-1">
              <h3>{project?.name}</h3>
              <div className="mb-2">
                <p className="h-10 text-sm" style={{ color: designTokens.semantic.text.secondary }}>
              ...
              <div className="mt-8 space-y-6">
                <div className="p-4 rounded-lg" style={{ backgroundColor: designTokens.semantic.background.secondary }}>
